        ...
        <div class="col-lg-8 col-xl-6">
            <div class="card">
                <div class="card-header border-0 pb-0 px-2 px-sm-3">
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center w-100">
                        <h4 style="font-family: 'Reddit Sans'; font-weight: 600; letter-spacing: 1px;" 
                            ...
                            <small class="text-muted d-block d-sm-inline ms-0 ms-sm-2 fs-6 fw-normal">
                                ID: {{ $data->id }}
                            </small>
                        </h4>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('attreq.update', $data->id) }}" id="editForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg @error('empcode') is-invalid @enderror" 
                                       ...
                                       value="{{ old('empcode', $data->empcode) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control form-control-lg @error('schddate') is-invalid @enderror" 
                                       ...
                                       value="{{ old('schddate', $data->schddate ? $data->schddate->format('Y-m-d') : '') }}" 
                                       required
                                       style="font-size: 14px; height: 45px;">
                                @error('schddate')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select form-select-lg @error('att') is-invalid @enderror" 
                                    ...
                                    @foreach($attendanceTypes as $type)
                                        <option value="{{ $type }}" 
                                            {{ old('att', $data->att) == $type ? 'selected' : '' }}
                                            data-color="{{ [
                                                'Manual' => 'primary',
                                                'Official Visit' => 'info',
                                                'Travel' => 'success',
                                ...
                                <div class="border rounded p-3 bg-light" style="height: 45px; display: flex; align-items: center;">
                                    <div class="d-flex justify-content-between w-100">
                                        <div>
                                            ...
                                            <span class="ms-2">{{ $data->created_at->format('d-M-Y') }}</span>
                                        </div>
                                        <div>
                                            <small class="text-muted">By:</small>
                                            <span class="ms-2">{{ $data->created_by ?: 'System' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <small class="text-muted">Record creation details</small>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('remarks') is-invalid @enderror" 
                                          ...
                                          style="font-size: 14px;">{{ old('remarks', $data->remarks) }}</textarea>
                                @error('remarks')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-3">
                                <button type="button" onclick="window.location='{{ route('attreq.index') }}'" class="btn btn-outline-secondary" style="width: 140px; height: 45px;">
                                    Cancel
                                </button>
                                <button type="submit" class="btn btn-primary" id="submitBtn" style="width: 140px; height: 45px;">
                                    Update Record
                                </button>
                            </div>
                        </div>
...
<style>
    ...
    /* Attendance type color indicators */
    ...
    /* Border colors for attendance type */
...
$(document).ready(function() {
    ...
    // Color indicator for attendance type
