...
<x-report-header title="Broker Report" />
<form method="GET" action="{{ url('/broker') }}" class="mb-4">
<div class="row g-3">
                <!-- From Date -->
                ...
                <div class="col-md-3 d-flex align-items-center">
                    ...
                    <a href="{{ url('/broker') }}" class="btn btn-outline-secondary me-1" title="Reset">
            ...
            <tr>
                ...
                <tbody>
                    ...
                    <td class="numeric" style="text-align: right;">
                        {{ trim($record['TOT_PRE'] ?? '') === '&nbsp;' || empty(trim($record['TOT_PRE'] ?? '')) ? 'N/A' : $record['TOT_PRE'] }}
                    </td>
                    <td class="numeric" style="text-align: right;">
                        {{ trim($record['GDH_TOTALSI'] ?? '') === '&nbsp;' || empty(trim($record['GDH_TOTALSI'] ?? '')) ? 'N/A' : $record['GDH_TOTALSI'] }}
                    </td>
                    <td class="numeric" style="text-align: right;">
                        {{ trim($record['GDH_NETPREMIUM'] ?? '') === '&nbsp;' || empty(trim($record['GDH_NETPREMIUM'] ?? '')) ? 'N/A' : $record['GDH_NETPREMIUM'] }}
                    </td>      
                    </tr>
