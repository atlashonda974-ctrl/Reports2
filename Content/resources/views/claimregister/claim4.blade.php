...
<body>
        ...
        <form method="GET" action="{{ url('/cr4') }}" class="mb-4">
            <div class="row g-3">
                ...
                <div class="col-md-4 d-flex align-items-center">
                    ...
                    <a href="{{ url('/cr4') }}" class="btn btn-outline-secondary me-2" title="Reset">
    ...
    <div class="d-flex justify-content-start mb-3">
        ...
        @else 
            <table id="reportsTable" class="table table-bordered table-responsive">
                ...
                <tfoot>
                    <tr>
                        <th colspan="11" style="text-align: right;">Total Loss Claimed</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Initialize Select2 for insurance dropdown with different placeholder
            $('#insu').select2({
            ...
            var table = $('#reportsTable').DataTable({
                ...
                "footerCallback": function (row, data, start, end, display) {
                    ...
                    // Calculate total for GIH_LOSSCLAIMED (column index 11)
                    var totalLossClaimed = api.column(11).data().reduce(function(a, b) {
