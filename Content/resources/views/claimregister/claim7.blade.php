...
@section('content')
    <style>
        ...
        * {
        ...
        /* FIX: Intimation card must not stretch to row height */
        .card-intimation {
    ...
    <div class="content-body">
        <div style="margin: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                    <div class="card overflow-hidden card-intimation" style="height:auto !important;">
                        <div class="card-body" style="padding: 12px 15px !important; margin:0 !important;">
                            ...
                            <div class="row" style="margin:0 0 10px 0;">
                                <div class="col-4" style="text-align:center;">
                                    ...
                                    <div style="display:inline-flex; align-items:baseline; justify-content:center; gap:4px; white-space:nowrap;">
                                        <a href="{{ url('/claimInt?start_date='.date('Y-01-01').'&end_date='.date('Y-m-d')) }}"
                                ...
                                <div class="col-4" style="text-align:center;">
                                    ...
                                    <a href="{{ url('/claimInt?start_date='.date('Y-01-01',strtotime('-1 year')).'&end_date='.date('Y-m-d',strtotime('-1 year'))) }}"
                                       target="_blank" class="claims-link"
                                ...
                                <div class="col-4" style="text-align:center;">
                                    ...
                                    <a href="{{ url('/claimInt?start_date='.date('Y-m-d').'&end_date='.date('Y-m-d')) }}"
                                       target="_blank" class="claims-link"
                            ...
                            <!-- Department table — 2-col per dept so number & % never shift header alignment -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @foreach (array_keys($deptNames) as $code)
                                                ...
                                                <td style="text-align:right; padding:3px 1px 3px 0; white-space:nowrap;">
                                                    @if($currentCount > 0)
                                                        <a href="{{ url('/claimInt?start_date='.date('Y-01-01').'&end_date='.date('Y-m-d').'&new_category='.urlencode($deptName)) }}"
                                                           target="_blank" class="claims-link"
                                        ...
                                        <tr>
                                            ...
                                            @foreach (array_keys($deptNames) as $code)
                                                ...
                                                <td style="text-align:right; padding:3px 1px 3px 0; white-space:nowrap;">
                                                    @if($count > 0)
                                                        <a href="{{ url('/claimInt?start_date='.date('Y-01-01',strtotime('-1 year')).'&end_date='.date('Y-m-d',strtotime('-1 year')).'&new_category='.urlencode($deptName)) }}"
                                                           target="_blank" class="claims-link"
                ...
                <!-- CARD 2 — Claim Settled -->
                <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                    <div class="card overflow-hidden card-settled">
                        <div class="card-body" style="padding:12px 15px !important; margin:0 !important;">
                            ...
                            <div style="margin-left:5px;">
                                <p style="margin:0; font-size:13px; color:#000;">Current Year Settled</p>
                            ...
                            <div class="stats-row" style="margin:8px 5px !important;">
                                <div class="stat-item">
                                    <div class="stat-label">Last Year</div>
                                    <div class="stat-value">{{ number_format($lastYearTotalSettled) }}</div>
                                </div>
                            </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            @foreach ($deptNames as $name)
                                                <th style="text-align:center; padding:2px; font-weight:600;">{{ $name }}</th>
                                            @endforeach
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td style="padding:2px; font-weight:600;">CY:</td>
                                            @foreach (array_keys($deptNames) as $code)
                                                <td style="text-align:center; padding:2px;">{{ number_format($deptLookupSettled[$code]['current'] ?? 0) }}</td>
                                            @endforeach
                                        </tr>
                                        <tr>
                                            <td style="padding:2px; font-weight:600;">LY:</td>
                                            @foreach (array_keys($deptNames) as $code)
                                                <td style="text-align:center; padding:2px;">{{ number_format($deptLookupSettled[$code]['last'] ?? 0) }}</td>
                                            @endforeach
                                        </tr>
                                    </tbody>
                                </table>
                ...
                <!-- CARD 3 — Surveyor & Workshop -->
                <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                    <div class="card overflow-hidden card-survey">
                        <div class="card-body" style="padding:12px 15px !important; margin:0 !important;">
                            ...
                            <div style="margin-bottom:10px;">
                                <p style="margin:0; font-size:12px; font-weight:600; color:#000;">
                                    <i class="fas fa-search" style="font-size:10px; margin-right:5px;"></i>Surveyor
                                </p>
                                ...
                                <div style="display:flex; justify-content:space-between;">
                                    ...
                                    <span style="font-size:11px; font-weight:600;">{{ number_format($surveyData['GPD_PAYEE_COUNT']) }}</span>
                                </div>
                            </div>

                            <div>
                                <p style="margin:0; font-size:12px; font-weight:600; color:#000;">
                                    <i class="fas fa-tools" style="font-size:10px; margin-right:5px;"></i>Workshop
                                </p>
                                <div style="display:flex; justify-content:space-between; margin-top:4px;">
                                    <span style="font-size:11px;">Amount:</span>
                                    <span style="font-size:11px; font-weight:600;">
                                ...
                                <div style="display:flex; justify-content:space-between;">
                                    <span style="font-size:11px;">Count:</span>
                                    <span style="font-size:11px; font-weight:600;">{{ number_format($workshopData['GPD_PAYEE_COUNT']) }}</span>
                                </div>
                            </div>
                ...
                <!-- CARD 4 — Total OS -->
                <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                    <div class="card overflow-hidden card-os">
                        <div class="card-body" style="padding:12px 15px !important; margin:0 !important;">
                            ...
                            <div class="os-table-container">
                                <table class="custom-table small-table" style="width:100%;">
                                    <thead>
                                        <tr>
                                            <th>O/S</th>
                                            <th class="text-right">Total</th>
                                            <th class="text-right">0-7</th>
                                            <th class="text-right">8-15</th>
                                    ...
                                    <tbody>
                                        @foreach (['Surveyor', 'Report', 'Stl'] as $type)
                                            @php
                                                ...
                                                $total = 0;
                                                foreach ($days as $d) { $total += $combinedData[$type][$d] ?? 0; }
                                            @endphp
                                            <tr>
                                                <td>{{ $type }}</td>
                                                <td class="text-right font-weight-bold">{{ number_format($total) }}</td>
                                                @foreach ($days as $d)
                                                    <td class="text-right">{{ number_format($combinedData[$type][$d] ?? 0) }}</td>
                                                @endforeach
                                            </tr>
                                        @endforeach
                                    </tbody>
            ...
            <!-- ============================================================
                 ROW 2 — CHARTS (4 charts in one row)
                 ============================================================ -->
            <div class="row" style="margin-top:15px;">

                <!-- Bar Chart — Month-wise Claims -->
                ...
                <!-- Donut Chart — Dept-wise Distribution -->
                <div class="col-xl-3 col-lg-6 col-md-12">
                    <div class="card overflow-hidden">
                        <div class="card-body px-4 py-4">
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
                        ...
                        <div class="card-body px-4 py-4">
                            ...
                            <div class="chart-container" style="height:150px; display:flex; align-items:center; justify-content:center; background:#f8f9fa; border:2px dashed #dee2e6; border-radius:6px;">
                                <div style="text-align:center; color:#adb5bd;">
                                    <i class="fas fa-chart-line" style="font-size:28px; margin-bottom:8px; display:block;"></i>
                                    <span style="font-size:11px;">Placeholder — Chart coming soon</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-12">
                    <div class="card overflow-hidden">
                        <div class="card-body px-4 py-4">
                            ...
                            <div class="chart-container" style="height:150px; display:flex; align-items:center; justify-content:center; background:#f8f9fa; border:2px dashed #dee2e6; border-radius:6px;">
                                <div style="text-align:center; color:#adb5bd;">
                                    <i class="fas fa-chart-area" style="font-size:28px; margin-bottom:8px; display:block;"></i>
                                    <span style="font-size:11px;">Placeholder — Chart coming soon</span>
                                </div>
                            </div>
                        </div>
