            ...
            <div class="row g-3">
                ...
                <div class="col-md-3 d-flex align-items-center">
                    ...
                    <select name="insurance_type" id="insurance_type" class="form-control">
                        <option value="All" {{ request('insurance_type', $selected_insurance_type ?? 'All') == 'All' ? 'selected' : '' }}>All Types</option>
                        <option value="D" {{ request('insurance_type', $selected_insurance_type ?? 'All') == 'D' ? 'selected' : '' }}>Direct (D)</option>
                        <option value="I" {{ request('insurance_type', $selected_insurance_type ?? 'All') == 'I' ? 'selected' : '' }}>Indirect (I)</option>
                    </select>
                </div>
