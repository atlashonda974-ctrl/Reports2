...
<x-report-header title="User Report" />
...
<div class="row g-3">
    ...
    @else
        ...
        <tr>
            <td>{{ $record['SUS_USERCODE'] ?? 'N/A' }}</td>
            <td>{{ $record['SUS_NAME'] ?? 'N/A' }}</td>
            <td>{{ $record['SUS_ACTIVE'] ?? 'N/A' }}</td>
            ...
            <td>{{ $record['SSP_DATETIME'] ?? 'N/A' }}</td>
            <td>{{ $record['SSP_OPERATION'] ?? 'N/A' }}</td>
            <td>{{ $record['SSP_REMARKS'] ?? 'N/A' }}</td>
            <td>{{ $record['SSP_NETWORKID'] ?? 'N/A' }}</td>
        </tr>
        @endforeach
            </tbody>
            <tfoot>
